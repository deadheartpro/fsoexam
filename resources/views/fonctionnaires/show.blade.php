									...
									<div class="tab-pane active" id="profile">
										<form role="form">
											<div class="form-group">
												...
												<input type="text" readonly value="{{$fonctionnaire->nom}} {{$fonctionnaire->prenom}}" id="FullName" class="form-control">
											</div>
											<div class="form-group">
												<label for="CIN">CIN</label>
												<input type="text" readonly value="{{$fonctionnaire->cin}}" id="cin" class="form-control">
											</div>
											<div class="form-group">
												<label for="SEXE">sexe</label>
												<input type="text" readonly value="{{$fonctionnaire->sexe}}" id="sexe" class="form-control">
											</div>
                                            <div class="form-group">
												<label for="type">type</label>
												<input type="text" readonly value="{{$fonctionnaire->type}}" id="type" class="form-control">
											</div>
											<div class="form-group">
												<label for="etat">etat</label>
												<input type="text" readonly value="{{$fonctionnaire->etat}}" id="etat" class="form-control">
											</div>
                                            
											<div class="form-group">
												<label for="service_nom">Service</label>
												<input type="text" readonly value="{{ $fonctionnaire->service->nom }}" id="service" class="form-control">
