						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">Fonctionnaires</h4>
							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="example" class="table key-buttons text-md-nowrap">
										<thead>
											<tr>
												<th class="border-bottom-0">Nom & Prenom</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($fonctionnaires as $fonctionnaire)
                                                    <tr>
                                                        ...
                                                        <td>{{ $fonctionnaire->type }}</td>
                                                        <td>{{ $fonctionnaire->etat }}</td>
                                                        <td>{{ optional($fonctionnaire->service)->nom }}</td>
                                                    </tr>
